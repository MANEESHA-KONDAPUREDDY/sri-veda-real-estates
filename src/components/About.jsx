...
const About = () => {
  ...
  return (
    <section id="about" className="relative py-24 lg:py-32 bg-gray-800 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-gray-900/90 via-gray-900/40 to-transparent flex items-end p-8">
                  <div className="text-center w-full">
                    ...
                    <div className="text-emerald-400 text-sm tracking-widest uppercase mt-2 font-semibold">
                      Years of Excellence
                    </div>
                  </div>
                </div>
              ...
              {/* Floating card */}
              <motion.div
                className="absolute -bottom-6 -right-6 bg-gray-900 rounded-2xl shadow-xl p-6 border border-gray-700"
              ...
              {/* Decorative corner */}
              <div className="absolute -top-4 -left-4 w-20 h-20 border-t-4 border-l-4 border-emerald-500 rounded-tl-3xl" />
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              {features.map((feature, i) => (
                <motion.div
                  key={i}
                  className="group relative flex items-start gap-3 p-5 rounded-2xl border border-gray-700 hover:border-emerald-500/50 bg-gray-900 hover:shadow-xl hover:shadow-emerald-500/10 transition-all duration-500 cursor-default overflow-hidden"
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 via-teal-500/5 to-green-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                  <motion.div
                    className="relative w-12 h-12 bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-xl flex items-center justify-center shrink-0 group-hover:from-emerald-500/30 group-hover:to-teal-500/30 transition-all duration-300"
                    whileHover={{ rotate: [0, -10, 10, 0], scale: 1.1 }}
                    transition={{ duration: 0.5, ease: [0.4, 0, 0.2, 1] }}
                  >
                    <feature.icon className="w-6 h-6 text-emerald-400" strokeWidth={2.5} />
                  </motion.div>
                  <div className="relative">
                    <h4 className="font-poppins font-bold text-white text-base group-hover:text-emerald-400 transition-colors">
                      {feature.title}
                    </h4>
                    <p className="text-gray-400 text-sm mt-1 leading-relaxed">{feature.desc}</p>
                  </div>

                  {/* Decorative corner */}
                  <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-bl from-emerald-500/10 to-transparent rounded-bl-full opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                </motion.div>
              ))}
            </div>
          </motion.div>
