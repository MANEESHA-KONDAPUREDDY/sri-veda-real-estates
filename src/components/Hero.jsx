  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        {/* Base gradient - Dark Purple/Cyan theme */}
        ...
        {/* Parallax Layer 1 - Far back - Purple */}
        <motion.div
          ...
          return (
            <motion.div
              ...
              style={{
                ...
                background: randomZ > 0 ? 'rgba(34, 211, 238, 0.5)' : 'rgba(139, 92, 246, 0.4)',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <motion.div
              className="inline-flex items-center gap-2 bg-slate-900/50 border border-cyan-400/30 rounded-full px-4 py-2 mb-8 backdrop-blur-sm"
            ...
            >
              <MapPin className="w-4 h-4 text-cyan-400" style={{ filter: 'drop-shadow(0 0 8px rgba(6, 182, 212, 0.5))' }} />
              <span className="text-cyan-400 text-sm font-medium">Ongole, Andhra Pradesh</span>
            </motion.div>
            ...
            <motion.h1
              ...
              style={{ textShadow: '2px 2px 20px rgba(139, 92, 246, 0.8)' }}
            >
              Find Your
              <br />
              <span className="relative inline-block">
                <span className="relative z-10 bg-gradient-to-r from-purple-400 via-cyan-400 to-purple-500 bg-clip-text text-transparent">Dream Property</span>
                <motion.span
                  className="absolute -inset-1 bg-gradient-to-r from-cyan-400/30 to-purple-500/20 blur-2xl -z-10"
                  animate={{ opacity: [0.5, 0.9, 0.5], scale: [1, 1.1, 1] }}
                  transition={{ duration: 3, repeat: Infinity, ease: [0.4, 0, 0.2, 1] }}
                />
              </span>
              <br />
              <span className="text-cyan-400">in Ongole</span>
            </motion.h1>
            ...
            >
              <motion.a
                href="#projects"
                className="group relative flex items-center gap-2 bg-gradient-to-r from-purple-600 via-purple-500 to-cyan-500 hover:from-purple-700 hover:to-cyan-600 text-white font-bold px-8 py-4 rounded-full text-sm transition-all overflow-hidden shadow-3d-button neon-cyan-hover"
              ...
              <motion.a
                href="#contact"
                className="group relative flex items-center gap-2 border-2 border-purple-400/50 hover:border-cyan-400 bg-slate-800/40 backdrop-blur-sm text-cyan-400 font-semibold px-8 py-4 rounded-full text-sm transition-all overflow-hidden neon-purple-hover"
                initial={{ opacity: 0, scale: 0.9 }}
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: true, amount: 0.3 }}
            ...
            <motion.div
              className="flex gap-8 mt-14 pt-8 border-t border-cyan-400/20"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.3 }}
            ...
            >
              {[
                ...
                <motion.div
                  ...
                  style={{ transformStyle: 'preserve-3d' }}
                >
                  <div className="text-2xl font-poppins font-bold text-cyan-400" style={{ textShadow: '0 0 20px rgba(6, 182, 212, 0.6)' }}>
                    {stat.number}
                  </div>
          ...
          <div className="hidden lg:block">
            <div className="relative perspective-1500">
              ...
              <motion.div
                ref={cardRef}
                className="relative z-10 rounded-3xl overflow-hidden bg-white/5 backdrop-blur-sm p-6 border border-purple-400/30 shadow-3d-card transform-3d neon-cyan-hover"
                ...
                style={{
                  transformStyle: 'preserve-3d',
                  boxShadow: `${mousePosition.rotateY * 2}px ${-mousePosition.rotateX * 2}px 60px rgba(6, 182, 212, 0.4)`,
                }}
              >
                {/* Promotional Image */}
                <motion.img
                ...
                <motion.div
                  className="absolute inset-0 bg-gradient-to-br from-cyan-500/20 via-purple-600/20 to-cyan-400/10 blur-2xl -z-10"
                  animate={{
                    opacity: [0.3, 0.7, 0.3],
                    scale: [1, 1.05, 1],
                  }}
                ...
                <motion.div
                  className="absolute -top-3 -right-3 bg-gradient-to-r from-purple-600 to-cyan-500 text-white font-bold text-xs px-5 py-2.5 rounded-full shadow-3d-button neon-dual"
                  animate={{
                    rotateY: [0, 360],
                    scale: [1, 1.08, 1],
                  }}
              ...
              <motion.div
                className="absolute -top-8 -left-8 w-32 h-32 border-2 border-cyan-400/30 rounded-3xl"
                animate={{
                  rotateX: [0, 360],
                  rotateY: [0, 180],
                  rotateZ: [0, 90],
      ...
      <motion.div
        ...
        style={{ transformStyle: 'preserve-3d' }}
      >
        <div className="w-6 h-10 border-2 border-cyan-400/50 rounded-full flex justify-center backdrop-blur-sm bg-slate-800/20">
          <motion.div
            className="w-1.5 h-3 bg-cyan-400 rounded-full mt-1.5"
